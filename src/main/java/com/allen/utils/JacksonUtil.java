...
/**
 * @Author: allen @Date: 2024/3/4 18:51 @Description:
 */
import com.allen.exception.JacksonException;
...
public class JacksonUtil {
  ...
  public static JsonNode from(File file) {
    try {
      ...
      throw new JacksonException("jackson from file, file: {}", file.getPath(), e);
    }
  }
  ...
  public static <V> V getAsObject(String json, String key, Class<V> type) {
    ...
    try {
      ...
      throw new JacksonException(
          "jackson get list error, json: {}, key: {}, type: {}", json, key, type, e);
    }
  }
  ...
  public static JsonNode getAsJsonObject(String json, String key) {
    try {
      ...
      throw new JacksonException(
          "jackson get object from json error, json: {}, key: {}", json, key, e);
    }
  }

  /**
   * 将string字符串转成JsonNode对象
   *
   * @return JsonNode
   */
  public static JsonNode getAsJsonObject(String json) {
    try {
      return mapper.readTree(json);
    } catch (IOException e) {
      throw new JacksonException(
          "jackson get jsonNode from string json error, json: {}, error: {}", json, e);
    }
  }
  ...
  public static <V> String add(String json, String key, V value) {
    try {
      ...
      throw new JacksonException(
          "jackson add error, json: {}, key: {}, value: {}", json, key, value, e);
    }
  }
  ...
  public static <V> String update(String json, String key, V value) {
    try {
      ...
      throw new JacksonException(
          "jackson update error, json: {}, key: {}, value: {}", json, key, value, e);
    }
  }
   ...
   * @param type List元素type
   * @return List
   * @param <V> Class类型
   */
  public static <V> List<V> toList(JsonNode jsonNode, Class<V> type) {
    try {
      return mapper.readerForListOf(type).readValue(jsonNode);
    } catch (IOException e) {
      throw new JacksonException(
          "jackson format json to list error, json: {}", jsonNode.asText(), e);
    }
  }
}
