...
public class MessageProducer {
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        props.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, "10.10.16.107:9092");
         /*
         发出消息持久化机制参数
        ...
        */
        ...
        for (int i = 1; i <= msgNum; i++) {
            KafkaDTO dto = new KafkaDTO(UuidUtil.getStrUuid(), "this test data" + counter);
